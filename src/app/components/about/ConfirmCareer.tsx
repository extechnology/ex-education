...
function ConfirmCareer() {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="flex max-w-7xl mx-auto py-5">
        <div className="w-2/3 content-center space-y-5">
          <h1 className="font-bold text-3xl text-fuchsia-700">
            Confirm your career in the <br /> Digital & Technology Profession.
          </h1>
          <p className="text-justify w-[90%] text-lg">
